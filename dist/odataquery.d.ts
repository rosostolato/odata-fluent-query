import { IFilterBuilder, IFilterExpression, IFilterBuilderTyped } from "./filterbuilder";
import { IOrderByBuilder, IOrderByExpression, IOrderBy } from "./orderbyBuilder";
 ...
 */
export declare class OQuery<T> extends ODataQuery<T> {
}
